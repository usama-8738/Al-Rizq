package com.example.alrizq.ui.donor.donations;
...
import com.example.alrizq.databinding.ActivityDonarDonationBinding;
import com.example.alrizq.ui.restaurent.donation.DonationModel;
...
public class DonorDonationActivity extends AppCompatActivity {

    ActivityDonarDonationBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDonarDonationBinding.inflate(getLayoutInflater());
        ...
        binding.timeOPrepration.getEditText().setOnClickListener(view -> {
            ...
            mTimePicker = new TimePickerDialog(DonorDonationActivity.this, (timePicker, selectedHour, selectedMinute) -> {
        ...
        binding.submit.setOnClickListener(view -> {
            ...
            if (!Validation.itemName(itemName, binding.itemName) | !Validation.itemName(timeOPrepration, binding.timeOPrepration) | !Validation.itemName(quantity, binding.quantity) | !Validation.itemName(address, binding.address)) {
                ...
                Toast.makeText(getApplicationContext(), "Please select if utensils are required or not?", Toast.LENGTH_SHORT).show();
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                donation.setImage(downloadUrl);
                                donation.setId(id);
                                donation.setItemName(itemName);
                                donation.setTimeOfPreparation(timeOPrepration);
                                donation.setQuantity(quantity);
                                donation.setAddress(address);
                                donation.setUtensil(utensil);
                                donation.setStatus("Pending");
                                donation.setuId(Constant.userId);
                                donation.setCreatedAt(new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(new Date()));
                                databaseReference.child(id).setValue(donation).addOnSuccessListener(unused -> {
                                    Toast.makeText(DonorDonationActivity.this, "Donation added successful", Toast.LENGTH_SHORT).show();
                                }).addOnFailureListener(e -> {
                                    Toast.makeText(DonorDonationActivity.this, "Error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == IMAGE_PICK_GALLERY_CODE) {
                ...
                Glide.with(DonorDonationActivity.this)
                        .load(imageUri)
